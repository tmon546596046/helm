...
MUTABLE_IMAGE_RUDDER := ${IMAGE_PREFIX}/${SHORT_NAME_RUDDER}:${MUTABLE_VERSION}
ALLIMAGE             := ${DOCKER_REGISTRY}/${IMAGE_PREFIX}/${ALL_SHORT_NAME}:${DOCKER_VERSION}
MUTABLE_ALLIMAGE     := ${IMAGE_PREFIX}/${ALL_SHORT_NAME}:${MUTABLE_VERSION}
